...
2. Create the necessary tables (init_first_tables.sql)
...
4. Run load_raw_data.py using the file you donwloaded above;

5. Run "dbt run" command; 

6. Check the main_notebook - set up the desired date to process the position of the client
